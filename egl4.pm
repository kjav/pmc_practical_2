...
// How many secrets B knows
formula nB = ( ((a1_0=L  & a2_0=L) ? 1 : 0)
             + ((a1_1=L  & a2_1=L) ? 1 : 0)
             + ((a1_2=L  & a2_2=L) ? 1 : 0)
             + ((a1_3=L  & a2_3=L) ? 1 : 0)
             + ((a1_4=L  & a2_4=L) ? 1 : 0)
             ...
             + ((a1_8=L  & a2_8=L) ? 1 : 0)
             + ((a1_9=L  & a2_9=L) ? 1 : 0));
// How many secrets A knows
formula nA = ( ((b1_0=L  & b2_0=L) ? 1 : 0)
             + ((b1_1=L  & b2_1=L) ? 1 : 0)
             + ((b1_2=L  & b2_2=L) ? 1 : 0)
             + ((b1_3=L  & b2_3=L) ? 1 : 0)
             + ((b1_4=L  & b2_4=L) ? 1 : 0)
...
module scheduler
	...
	// B sends (1..L-1)th bit of last secret to A and switches back to A
	...
	// B sends the last bit of the 1st AND lst secret to A, and goes to next phase
	...
	// A sends (1..L-1)th bit of last secret to B, and moves to the next bit
	[receiveB] phase=2 & party=1 & N>1 & n=N-1 & b<L -> (n'=0) & (b'=b+1);
	// A sends the last bit of last secret to B, and moves to the next phase
...
rewards "secrets_A_knows"
	true : nA;
endrewards

rewards "secrets_B_knows"
	true : nB;
endrewards
